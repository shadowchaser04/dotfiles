...
# Version: 2.0
# Author: Shadow
# Last Update: Wednesday, 16 Jun, 2021,  9:30 PM
#==============================================================================
# autoconfig {{{1
...
# source the Gruvboxvbox theme
config.source("themes/base16-gruvbox-dark-hard.py")
...
# Options
# add just urls to a playlist then play each of the videos.
# download with youtube-dl then open with **
...
# download audio from hint
config.bind('<Ctrl-z>', "hint links spawn youtube-dl -x -o '~/Downloads/Audio/%(title)s.%(ext)s' {hint-url}")

# download image from hint
config.bind('x', 'hint images download')

# config.bind('X', 'hint links spawn wget -nd -P ~/Downloads/Images -A jpeg,jpg,bmp,png {url:pretty}')
