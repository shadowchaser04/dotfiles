-- https://redd.it/3t6s7k (author deleted; failed to ask for permission).
-- Date is set to dd/mmm/yy and time to machine-wide format.
...
local HISTFILE = (os.getenv('HOME')..'/.config')..'/mpv/mpvhistory.log';
